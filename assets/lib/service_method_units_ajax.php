...
if ($language_label_arr[1] != "" || $language_label_arr[3] != "" || $language_label_arr[4] != "" || $language_label_arr[5] != "")
   {  
      ...
      if($language_label_arr[5] != '')
         ...
         $label_decode_admin_unserial,$label_decode_error_unserial,$label_decode_extra_unserial);
   ...
   {    
         ...
         <?php  */    
         while ($arrs = mysqli_fetch_array($res)) {  $i++;  ?>            
                           ...
                           <tbody>
                              <tr>
                                 <td>                                                    
                                    ...
                                    <button id="ct-close-popover-delete-service-unit" class="btn btn-default btn-sm" href="javascript:void(0)" data-service_method_unitid="<?php echo $arrs['id']; ?>"><?php echo $label_language_values['cancel'];?>
                                     </button>                                                
                                  </td>
                              </tr>
                           </tbody>
...
<?php }elseif (isset($_POST['deleteid'])) {    
         ...
         if($cnt == 0){        
            ...
            $objservice_method_unit_rate->assign_design("ct_service_methods_design", 
            $_POST['method_id'],3);    
         }else{        
            echo "1";    
         }
...
<?php  }    }}elseif (isset($_POST['operation_getallqtyprice'])) {    
   ...
   <li class="form-group myunitqty_price_row<?php  echo $r['id']; ?>">
      ...
      <div class="col-xs-12 col-sm-2">                    
         <input id="myeditqty_units<?php  echo $r['id']; ?>" name="edtqty" class="form-control myloadedqty_units<?php  echo $r['id']; ?>" placeholder="1" value="<?php echo $r['units']
         ; ?>" type="text"/>           
      </div>
      <div class="price-rules-select">
         <select class="form-control myloadedrules_units<?php  echo $r['id']; ?>">
      ...
      <a href="javascript:void(0);" data-id="<?php echo $r['id']; ?>" class="btn btn-circle btn-success  pull-left update-addon-rule myloadedbtnsave_units"><i class="fa fa-thumbs-up"></i></a>                
      <a href="javascript:void(0);" data-id="<?php echo $r['id']; ?>" class="btn btn-circle btn-danger pull-left delete-addon-rule myloadedbtndelete_units"><i class="fa fa-trash"></i></a>            
   </form>
</li>
<?php     }    ?>    
<li class="form-group">
