...
elseif(isset($_POST['confirm_booking_cal'])){
	...
	$company_email = $settings->get_option('ct_email_sender_address');
	$service_name = $clientdetail['title'];
	$service_description = $clientdetail["addon_service_description"];
	if($admin_email == ""){
		$admin_email = $clientdetail['email'];	
	}
  $price=$general->ct_price_format($orderdetail[2],$symbol_position,$decimal);
					...
					?>
						<div class="col-xs-12">
							...
							<div class="cta-col6 reschedule-staffs"><?php  echo $staff_html; ?></div>
								<div class="cta-col4"><a href='javascript:void(0)' data-orderid='<?php  echo $order_id; ?>' class='select_res_date_time edit_staff btn btn-info' data-order-duration="<?php echo $oci['order_duration']; ?>">Select Date&Time</a>
							</div>
						</div>
						<?php 
						...
						<div class="col-xs-12">
							<div class="form-group">
								...
								<div class="cta-col6 ct-w-50 float-right mytime_slots_booking">
									...
									$slot_counter = 0;
									$time_schedule_auto = ['8:00:00','9:00:00','10:00:00','11:00:00','12:00:00','13:00:00','14:00:00','15:00:00','16:00:00','17:00:00','18:00:00','19:00:00','20:00:00'];
									?>
									<select class="selectpicker mydatepicker_appointment   form-control" id="myuser_reschedule_time" data-size="10" style="" >
										...
										if($time_schedule['off_day']!=true && isset($time_schedule['slots']) && sizeof((array)$time_schedule['slots'])>0 && $allbreak_counter != sizeof((array)$time_schedule['slots']) && $allofftime_counter != sizeof((array)$time_schedule['slots'])){
											...
											if($allbreak_counter == sizeof((array)$time_schedule['slots']) && sizeof((array)$time_schedule['slots'])!=0){ ?>
												<?php if(isset($_POST['getmytimescalendar'])){ ?>
													<?php foreach($time_schedule_auto as $slot) { ?>
														<?php
															if($settings->get_option('ct_time_format')==24){
																$slot_time = date("H:i",strtotime($slot));
															}else{
