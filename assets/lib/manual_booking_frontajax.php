    ...
    if($u_value_4['half_section'] == "E"){
      ...
      $hfsec=1;
        ...
        <div class="ct-bedrooms ct-btn-group ct-md-6 ct-sm-6">
            ...
            ?>
            <button id="minus-addon-<?php echo $u_value_4['id']; ?>" data-ids="<?php echo $u_value_4['id']; ?>" class="minuss ct-btn-left ct-small-btn" data-units_id="<?php echo $u_value_4['id']; ?>" data-duration_value="" data-method_name="<?php echo $u_value_4['units_title'] ?>" data-db-minqty="<?php echo $u_value_4["minlimit"]; ?>" data-hfsec="<?php echo $hfsec; ?>" type="button" data-service_id="<?php echo $_POST['service_id']; ?>" data-rate="" data-method_id="<?php echo $_POST['method_id']; ?>" data-type="<?php echo "method_units"; ?>" data-unit_symbol="<?php   echo $u_value_4['unit_symbol']; ?>" data-mnamee="<?php echo $mmnameee; ?>">-</button>
