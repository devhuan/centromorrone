...
class cleanto_dummy {
    ...
    public function add_services_method_unit() {
        $query = "insert into `" . $this->service_methods_units . "` (`id`,`services_id`,`methods_id`,`units_title`,`base_price`,`minlimit`,`maxlimit`,`status`, `position`,`limit_title`,`unit_symbol`,`half_section`,`uduration`) values(NULL,'" . $this->smu_service_id . "','" . $this->smu_methods_id . "','" . $this->smu_units_title . "','" . $this->smu_base_price . "','" . $this->smu_minlimit . "','" . $this->smu_maxlimit . "','" . $this->smu_status . "', '0','" . $this->smu_limit_title . "','" . $this->smu_unit_symbol . "','D','" . $this->smu_uduration . "')";
        $result = mysqli_query($this->conn, $query);
        $value = mysqli_insert_id($this->conn);
        return $value;
    }
