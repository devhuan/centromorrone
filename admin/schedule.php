...
include(dirname(dirname(__FILE__)) . "/objects/class_look_day.php");
...
$addon_det =array();
if($addon > 0){
    $res = $objservice_addon->getdataby_id($addon);
...
<div id="cta-staff-panel" class="panel tab-content">	
    <div class="panel-body">        
        ...
        <ul class="nav nav-tabs nav-justified ct-staff-right-menu">            
            <li class="active"><a href="#member-addbreaks" data-toggle="tab"><?php echo $label_language_values['add_breaks']; ?></a></li> 
            <li><a href="#member-details" data-toggle="tab"><?php echo $label_language_values['view_slots_by']; ?></a></li>            
        ...
        <div class="tab-pane active"> <!-- first staff nmember -->            
            <div class="container-fluid tab-content ct-staff-right-details"> 
                <!--INIZIO BLOCCO BREAKS-->
                <div class="tab-pane member-addbreaks active" id="member-addbreaks">                   
                    <div class="panel panel-default">                        
                        <div class="panel-body">                            
                            <?php
                            $breaks_weekname = array(
                                    ...
                                    <?php for ($i = $minweek; $i <= $maxweek; $i++) {
                                        ...
                                        echo "active";
                                            ...
                                            <div class="panel panel-default">   <div class="panel-body">   
                                                    <div class="riga-selezione-addon">
                                                        SELEZIONA L'ESAME DA GESTIRE <br><br>
                                                        <input id="birds" type="search" placeholder=" &#xf002;  Cerca prestazione o esame..." style="font-family:Arial, FontAwesome;width:100%;height:60px;font-size:20px;" />
                                                    </div><br><br>
                                                    <?php
                                                        if(array_count_values($addon_det)>0){
                                                            echo "<strong>ESAME SELEZIONATO: " . $addon_det['addon_service_name'];
                                                            echo"</strong>";
                                                        }?>
                                                    <br><br><br>
                                                    <?/*php if ($minweek == 1 && $maxweek == 1) {
                                                        ...
                                                        <?php }
                                                   */ ?>
                                                    <?php if(array_count_values($addon_det)>0 && $addon_det['id']){ ?>
                                                        <div class="mb-20">
                                                            <div class="addon-add-lock">
                                                                <a id="ct-add-staff-breaks-data-addon"  class="btn btn-small btn-success ct-small-br-btn myct-add-staff-breaks-data-addon"><?php echo 'Aggiungi blocco data'; ?></a>
                                                            </div>
                                                            <div id="staff-look-data-all" class="staff-look-data mt-10">
                                                                <?php if ($addon_det['block_date']) { ?>
                                                                <div class="date_set">
                                                                    <div class="date">
                                                                        <i class="fa fa-calendar mt-2"></i>
                                                                        <span class="starttime"><?= str_replace($english_date_array,$selected_lang_label,date($getdateformat, strtotime($addon_det['block_date']))); ?></span> <?php if (strtotime($addon_det['block_date']) < strtotime($addon_det['block_date_to'])) { ?>to <span class="starttime"><?= str_replace($english_date_array,$selected_lang_label,date($getdateformat, strtotime($addon_det['block_date_to']))); ?></span><?php } ?>
                                                                    </div>
                                                                    <div class="time">
                                                                        <i class="fa fa-clock-o mt-2"></i><span class="start_time"><?= str_replace($english_date_array,$selected_lang_label,date("h:i A",strtotime($addon_det['block_time_from']))) ?></span> to <span class="end_time"><?= str_replace($english_date_array,$selected_lang_label,date("h:i A",strtotime($addon_det['block_time_to']))) ?></span>
                                                                    </div>
                                                                </div>
                                                                <?php } ?>
                                                            </div>
                                                    ...
                                                    <ul class="list-unstyled" id="ct-staff-breaks">  
                                                        ...
                                                        for ($j = 1; $j <= 7; $j++) {
                                                            ...
                                                            ?> 
                                                            <li class="active">                                                                
                                                                <span class="col-sm-12 col-md-3 col-lg-3 col-xs-12 ct-day-name"><?php echo $label_language_values[strtolower($objdayweek_avail->get_daynamebyid($j))]; ?></span>
                                                                <span class="col-sm-12 col-md-2 col-lg-2 col-xs-12">
                                                                    <a id="ct-add-staff-breaks-data" data-weekid="<?php echo $i; ?>" data-staff_id="<?php echo $_SESSION['ct_adminid']; ?>" data-weekday="<?php echo $j; ?>"   class="btn btn-small btn-success ct-small-br-btn myct-add-staff-breaks-data" data-id="<?php echo $i; ?>_<?php echo $j; ?>"><?php echo 'Aggiungi blocco data'; ?></a>
                                                                    <?php
                                                                        $addon_lookday = [];
                                                                        if(array_count_values($addon_det)>0){
                                                                            $res = $addonlookday->getdataby_id($addon_det['id'], $j);
                                                                            foreach ($res as $value) {
                                                                                $addon_lookday = $value;
                                                                            };
                                                                        }
                                                                    ?>
                                                                    <div id="staff-look-data-<?= $j ?>" class="staff-look-data">
                                                                        <?php if (isset($addon_lookday['id']) && $addon_lookday['id']) { ?>
                                                                        <div class="date_set">
                                                                            <div class="date">
                                                                                <i class="fa fa-calendar mt-2"></i>
                                                                                <span class="starttime"><?= str_replace($english_date_array,$selected_lang_label,date($getdateformat, strtotime($addon_lookday['block_date']))); ?></span> 
                                                                            </div>
                                                                            <div class="time">
                                                                                <i class="fa fa-clock-o mt-2"></i><span class="start_time"><?= str_replace($english_date_array,$selected_lang_label,date("h:i A",strtotime($addon_lookday['block_time_from']))) ?></span> to <span class="end_time"><?= str_replace($english_date_array,$selected_lang_label,date("h:i A",strtotime($addon_lookday['block_time_to']))) ?></span>
                                                                            </div>
                                                                        </div>
                                                                        <?php } ?>
                                                                    </div>
                                                                ...
                                                                <?php //if ($getdatafrom_week_days[0] == 'Y' || $getdatafrom_week_days[0] == '') {
                                                                      if(1!=1){
                                                                    ?>                                                  
                                                                <span class="col-sm-2 col-md-2 col-lg-2 col-xs-12"></span>                                                                
                                                                    <?php
                                                                } else {
                                                                    ?>                                                                    
                                                                ...
                                                                <?php } ?>
                                                                <span class="col-sm-12 col-md-5 col-lg-5 col-xs-12 ct-staff-breaks-schedule"><ul class="list-unstyled" id="ct-add-break-ul<?php echo $i; ?>_<?php echo $j; ?>">  
                                                                <?php
                                                                $staff_id = $_SESSION['ct_adminid'];
                                                                $objoffbreaks->week_id = 1;
                                                                $objoffbreaks->weekday_id = $j;
                                                                $jc = $objoffbreaks->getdataby_week_day_id($staff_id, $addon);
                                                                while ($rrr = mysqli_fetch_array($jc)) {
                                                                    ...
                                                                    echo "selected";
                                                                                ...
                                                                                <select class="selectpicker selectpickerend" data-id="<?php echo $rrr['id']; ?>" data-weekid="<?php echo $rrr['week_id']; ?>" data-weekday="<?php echo $rrr['weekday_id']; ?>" data-size="10" style="display: none;">                                                                                <?php
                                                                                    $min = 0;
                                                                                    while ($min < 1440) {
                                                                                        if ($min == 1440) {
                                                                                            $timeValue = date('G:i', mktime(0, $min - 1, 0, 1, 1, 2015));
...
<?php } ?>                              <div id="services-addon-block-date" class="modal fade services-addon-block-date" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="vertical-alignment-helper">
                                                <div class="modal-dialog modal-md vertical-align-center">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" id="info_modal_close" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h4 class="modal-title">Dettagli sull'orario di blocco</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a href="javascript:void(0);" class="pull-left btn btn-info" id="edit_block_time">Tempo di aggiornamento</a>
                                                            <a href="javascript:void(0);" class="pull-left btn btn-info" id="cancel_block_time">Cancella</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <!--FINE BLOCCO BREAKS-->             
                <div class="tab-pane col-lg-12 col-md-12 col-sm-12 col-xs-12" id="member-details">                    
                ...
                <div class="tab-pane member-availabilty myloadedslots" id="member-availabilty">                 
                    ...
                    ?>                    
                    <form id="" method="POST">   
                        <input type="hidden" id="addon_id" value="<?=$addon?>">
                        <div class="panel panel-default">                            
                                                            ...
                                                            <li class="active">                                                            
                                                                ...
                                                                <span class="col-sm-2 col-md-2 col-lg-2 col-xs-12 my-schedule-main">															
                                                                    <label class="cta-col2" for="ct-monFirst<?php echo $i; ?><?php echo $j; ?>_<?php echo $getvalue[0]; ?>">																   
                                                                        <input class='chkdaynew' data-toggle="toggle" data-size="small" type='checkbox' id="ct-monFirst<?php echo $i; ?><?php echo $j; ?>_<?php echo $getvalue[0]; ?>" <?php if ($getvalue[6] == 'Y' || $getvalue[6] == '') {
                                                                           echo "";
                                                                       } else {
                                                                           echo "checked";
                                                                       }
...
<?php } ?>                                        
                ...
                <div class="tab-pane member-offdays mt-10" id="member-offdays">                    
                    <div class="panel panel-default">                        
                        <?php
                        $offday->user_id = $_SESSION['ct_adminid'];
                                ...
                                <div class="pull-left">                                    
                                    <div class="ct-custom-checkbox">                                        
                                        <ul class="ct-checkbox-list">                                            
                                            <li>                                                
                                                <input style="margin:0px;" type="checkbox"  class="fullmonthoff all" data-prov_id="<?php echo $_SESSION['ct_adminid']; ?>" id="<?php echo $year . '-' . $this_month; ?>" <?php
                        $offday->off_year_month = $year . '-' . $this_month;
                        ...
                        echo '</tr>'; /*  } */
                        echo '</table>';
                        ?>                    </div>                </div>            </div>            <!-- end first -->        </div>    </div></div><?php include (dirname(__FILE__) . '/footer.php'); ?><script type="text/javascript">    var ajax_url = '<?php echo AJAX_URL; ?>';</script>
